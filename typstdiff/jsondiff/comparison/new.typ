GNU CHANGED 6.2 test1.typ

= Introduction
In CHANGED report, we will explore the various \
factors that influence #emph[fluid CHANGED] in CHANGED and how \
CHANGED to the formation and behaviour of these natural structures.
...
$- x$ is the opposite CHANGED $x$

let #strong[name] = \[#strong[Typst!];\]
